        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">Product Management</h1>
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">View Product <a href="create_product.php" class="btn btn-primary"><i class="fas fa-plus"></i> Create Product</a>
               <a href="list_product.php" class="btn btn-success"><i class="fas fa-list"></i> List Product</a>
             </h6>
